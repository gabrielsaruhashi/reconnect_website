...
import {
  ...
  deleteInvitation
} from "../actions/action_connection";
    ...
    return (
      <div className="invitation_wrapper">
        ...
        <div className="invitation_wrapper__btn-actions">
          <button className="btn-reject" onClick={this.onReject}>
            Ignore
          </button>
          <button className="btn" onClick={this.onAccept}>
            <i className="fa fa-check-circle-o fa-2x" />Accept
          </button>
        </div>
      </div>
    );
...
export default connect(
  null,
  { createConnection, updateUserConnections, deleteInvitation }
)(Invitation);
