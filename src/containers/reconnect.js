...
class ReConnect extends Component {
  ...
  renderSuggestions() {
    ...
    if (this.props.invitations) {
      valid_suggestions = _.filter(this.props.suggestions, suggestion => {
        return (
          !(suggestion.uid in active_user.invitations) &&
        ...
        <div className="reconnect-wrapper">
          ...
          <div className="main_content">
            <div className="header">
              <h1>Invite</h1>
              <p>
                Here is a list of reconnectors that we believe that match your
